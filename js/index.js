let loadShowPopup = document.getElementById('loadShowPopup');
let sessionPopup = document.querySelector('.sessionPopup');
window.addEventListener('load', function() {
    setTimeout(()=>{
        loadShowPopup.classList.add('loadShowPopup');
    },2000);
...
//code for closeLoading popUp
const closeLoadPopup = ()=>{
    loadShowPopup.classList.remove('loadShowPopup')
};